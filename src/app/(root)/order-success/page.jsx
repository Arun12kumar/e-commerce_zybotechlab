...
const page = () => {
  ...
  const finaldate = `${stringDate}, ${Stringtime}`

  const cardData = {
    order_id: orderData.orderId,
    created_date: finaldate,
    product_name: orderData.product_nam,
    product_price: orderData.price,
    product_mrp: orderData.product_MRP,
    product_amount: orderData.price,
    quantity: 1,
  };
  ...
  return (
    <div className="min-h-screen flex py-5 justify-center w-full ">
      <div className="h-auto sm:h-[50vh] w-full flex flex-col items-center space-y-4 sm:space-y-5 md:space-y-6">
        ...
        {/* Date/Time */}
        <p className="text-white/40 text-sm sm:text-base md:text-md text-center">12:34 PM, 20th Dec 2025</p>
